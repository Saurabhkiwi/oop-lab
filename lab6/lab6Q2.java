...
public class StudentApp {
    public static void main(String[] args) {
        UGStudent ug1 = new UGStudent("UG001", "Saurabh", 18, 1, 50000);
        UGStudent ug2 = new UGStudent("UG002", "Suvan", 19, 2, 55000);
        PGStudent pg1 = new PGStudent("PG001", "Harsh", 22, 1, 75000);
        PGStudent pg2 = new PGStudent("PG002", "Akhil", 23, 2, 80000);
